...
use Laventure\Component\Container\Reflection\ReflectionService;
use PHPUnit\Framework\TestCase;
use PHPUnitTest\App\Service\Foo\MailService;
...
class ContainerTest extends TestCase
{
     ...
     */
     ...
     public function testBindings(): void
     {
          ...
          $this->container->bind(MailService::class, MailService::class);

          $this->assertSame($url, $this->container->get('url'));
          $this->assertInstanceOf(MailService::class, $this->container->get('mail'));
          $this->assertInstanceOf(MailService::class, $this->container->get(MailService::class));
